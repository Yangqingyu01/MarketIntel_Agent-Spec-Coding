...
- [ ] T008 Configure source metadata, credibility scoring, and content-type enums
- [ ] T009 Setup error handling, logging, and timeout or retry policies for collection workflows
...
- [ ] T017 [US1] Add source validation, credibility handling, and fact/inference labeling
- [ ] T018 [US1] Add logging and structured output mapping for user story 1 operations
...
- [ ] T024 [US2] Integrate with User Story 1 components and preserve metadata contracts
...
- [ ] TXXX Security hardening and public-source compliance review
